...
| Repo | PR | Title | Author | Mergeable | Checks | Link |
|------|----|-------|--------|-----------|--------|------|
| Eco-audit-web | #22 | chore(deps-dev): bump @tailwindcss/postcss from 4.2.1 to 4.2.2 | dependabot[bot] | ✅ MERGEABLE | ⏳ PENDING | [Link](https://github.com/NilsB44/Eco-audit-web/pull/22) |
| Eco-audit-web | #21 | chore(deps-dev): bump tailwindcss from 4.2.1 to 4.2.2 | dependabot[bot] | ✅ MERGEABLE | ⏳ PENDING | [Link](https://github.com/NilsB44/Eco-audit-web/pull/21) |
